...
// Same augmentation as `app`, but under moduleResolution "bundler" with an "exports" map
// that exposes only ".". The subpath import is expected to fail to resolve; the point is
// that ROOT augmentation still merges.
