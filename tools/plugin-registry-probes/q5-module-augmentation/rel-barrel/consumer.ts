...
// Augment the BARREL (index.ts), where the interface is only re-exported.
...
import type { PluginRegistry as PRDirect } from './plugins-support.js';

declare const viaBarrel: keyof PluginRegistry;
const _viaBarrel: 0 = viaBarrel;

declare const viaDirect: keyof PRDirect;
const _viaDirect: 0 = viaDirect;

declare const seenByLib: RegistryKeysSeenByLib;
const _seenByLib: 0 = seenByLib;

export const keep = [_viaBarrel, _viaDirect, _seenByLib];
