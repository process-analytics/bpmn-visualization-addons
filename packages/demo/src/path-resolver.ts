...
import { BpmnVisualization, ElementsPlugin, PathResolver, StylePlugin } from '@process-analytics/bpmn-visualization-addons';
import { FitType, ShapeUtil } from 'bpmn-visualization';
...
const getAllFlowNodes = (): BpmnElement[] => elementsPlugin.getElementsByKinds(ShapeUtil.flowNodeKinds());
